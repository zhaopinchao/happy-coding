            ...
            try {
                ...
                if (events > 0) {
                    ...
                    while (selectionKeys.hasNext()) {
                        ...
                        System.out.print("isValid = " + key.isValid() + ", ");
                        System.out.println("isValid = " + key.isConnectable());
                        if (key.isAcceptable()) {
                            accept(key);
                        } else {
...
//                            service.submit(new NioServerHandler(key));
                        ...
                        System.out.print("isReadable = " + key.isValid() + ", ");
                    }
                }
            } catch (IOException e) {
                e.printStackTrace();
        ...
        public void run() {
            try {
                if (selectionKey.isReadable()) {
                    ...
                    selectionKey.cancel();
                    System.out.println("取消后 isValid = " + selectionKey.isValid());
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
